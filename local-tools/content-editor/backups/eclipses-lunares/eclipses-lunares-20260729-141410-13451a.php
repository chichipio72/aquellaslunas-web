...
return [
    ...
    */
    ...
    'resumen' =>
        'Un eclipse lunar ocurre cuando la Luna atraviesa la sombra de la Tierra. Según su recorrido, el eclipse puede ser penumbral, parcial o total.',
    ...
    */
    ...
    'sabias_que' => [
        ...
        [
            ...
            'titulo' =>
                '¿Sabías por qué la Luna puede verse rojiza durante un eclipse total?',

            'respuesta' =>
                'La atmósfera terrestre desvía hacia la sombra parte de la luz roja del Sol. Esa luz alcanza la superficie lunar y puede darle tonos cobrizos, anaranjados o rojizos.',
        ...
        [
            ...
            'titulo' =>
                '¿Sabías que no hay un eclipse lunar en cada Luna llena?',

            'respuesta' =>
                'La órbita de la Luna está inclinada respecto de la órbita terrestre alrededor del Sol. La mayoría de las veces, durante la Luna llena pasa por encima o por debajo de la sombra terrestre.',
    ...
    */
    ...
    'trivias' => [
        ...
        [
            ...
            'pregunta' =>
                '¿En qué fase puede ocurrir un eclipse lunar?',
            ...
            'opciones' => [
                ...
                [
                    ...
                    'explicacion' =>
                        'Un eclipse lunar solo puede producirse durante la Luna llena, cuando la Tierra se encuentra aproximadamente entre el Sol y la Luna.',
                ],
        ...
        [
            ...
            'pregunta' =>
                '¿Qué parte de la sombra terrestre produce la etapa más oscura de un eclipse lunar?',
            ...
            'opciones' => [
                ...
                [
                    ...
                    'explicacion' =>
                        'La umbra es la zona central y más oscura de la sombra terrestre. Cuando la Luna entra en ella se produce la fase parcial o total del eclipse.',
                ],
