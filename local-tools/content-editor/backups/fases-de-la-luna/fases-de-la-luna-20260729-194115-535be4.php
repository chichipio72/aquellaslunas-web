...
return [
    ...
    */
    ...
    'resumen' =>
        'Las fases lunares no se producen por la sombra de la Tierra, sino por la forma en que vemos la parte iluminada de la Luna mientras orbita nuestro planeta.',
    ...
    */
    ...
    'sabias_que' => [
        ...
        [
            ...
            'respuesta' =>
                'Porque durante la Luna llena nuestro satélite se encuentra aproximadamente en dirección opuesta al Sol. Cuando el Sol se oculta por el oeste, la Luna aparece por el este.',
        ...
        [
            ...
            'respuesta' =>
                'La Luna tarda prácticamente el mismo tiempo en girar sobre su eje que en dar una vuelta alrededor de la Tierra. Por eso siempre nos muestra casi el mismo hemisferio.',
    ...
    */
    ...
    'trivias' => [
        ...
        [
            ...
            'pregunta' =>
                '¿Qué produce las fases de la Luna?',
            ...
            'opciones' => [
                ...
                [
                    ...
                    'explicacion' =>
                        'La Luna siempre tiene una mitad iluminada por el Sol. Las fases dependen de cuánto de esa mitad iluminada podemos ver desde nuestro planeta.',
                ],
        ...
        [
            ...
            'pregunta' =>
                '¿En qué fase ocurre un eclipse lunar total?',
            ...
            'opciones' => [
                ...
                [
                    ...
                    'explicacion' =>
                        'Los eclipses lunares solo pueden ocurrir durante la Luna llena, cuando la Tierra queda aproximadamente entre el Sol y la Luna.',
                ],
