...
return [
    ...
    'sabias_que' => [
        [
            ...
            'imagen' => NULL,
            'referencia' => [
                'articulo' => 'pascua-y-luna-llena',
                'ancla' => 'cuando-se-celebra',
            ],
        ],
        [
            'id' => 'sq-02',
    ...
    'trivias' => [
        [
            ...
            'referencia' => [
                'articulo' => 'pascua-y-luna-llena',
                'ancla' => 'como-se-calcula',
            ],
        ],
        [
            'id' => 'tr-02',
            'visible' => true,
            'pregunta' => '¿Qué día de la semana se celebra la Pascua?',
            'imagen' => NULL,
            'opciones' => [
                [
                    'texto' => 'Viernes',
                ...
                [
                    'texto' => 'Domingo',
                    'explicacion' => 'La Pascua se celebra el domingo siguiente a la primera Luna llena posterior al equinoccio de marzo.',
                ],
                [
                    'texto' => 'Puede ser cualquier día',
                ],
            ],
            'referencia' => [
                'articulo' => 'pascua-y-luna-llena',
