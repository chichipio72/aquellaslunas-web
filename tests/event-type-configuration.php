...
try {
    astronomyEventTypeUpdate($connection, [
        $targetId => ['name' => 'Luna nueva editorial', 'enabled' => false, 'surfaces' => [ASTRONOMY_EVENT_SURFACE_TODAY]],
    ]);
    ...
    astronomyEventTypeUpdate($connection, [
        $targetId => ['name' => 'Luna nueva editorial', 'enabled' => true, 'surfaces' => [ASTRONOMY_EVENT_SURFACE_TODAY]],
    ]);
