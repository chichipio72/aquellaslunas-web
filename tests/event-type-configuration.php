...
eventTypeAssert(astronomyEventVisibleOnSurface($node, ASTRONOMY_EVENT_SURFACE_EVENTS, $unavailable), 'El fallback no publicó nodos en Eventos lunares.');
eventTypeAssert(astronomyEventVisibleOnSurface($node, ASTRONOMY_EVENT_SURFACE_TODAY, $unavailable), 'El fallback no publicó nodos en El cielo hoy.');
eventTypeAssert(astronomyEventVisibleOnSurface($node, ASTRONOMY_EVENT_SURFACE_HOME_UPCOMING, $unavailable), 'El fallback no habilitó nodos en Lo próximo.');
eventTypeAssert(!astronomyEventVisibleOnSurface($node, ASTRONOMY_EVENT_SURFACE_TONIGHT, $unavailable), 'El fallback publicó nodos en Esta noche.');
eventTypeAssert(!astronomyEventRelevantTonight($node, $unavailable), 'El nodo quedó marcado como relevante esta noche.');
