...
grep -q 'class="store-admin-navigation__public-link" href="../">Ver sitio público</a>' "$work_dir/admin-authenticated"
...
grep -q 'class="store-admin-navigation__public-link" href="../">Ver sitio público</a>' "$work_dir/admin-photos-authenticated"
...
grep -q 'class="store-admin-navigation__public-link" href="../../">Ver sitio público</a>' "$work_dir/admin-contents-authenticated"
