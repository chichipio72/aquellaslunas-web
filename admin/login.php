...
if (storeAdminIsAuthenticated()) {
    header('Location: fotos.php', true, 303);
    exit;
}
$error = false;
...
<head>
    ...
    <meta name="robots" content="noindex,nofollow,noarchive"><title>Administración de fotos</title>
...
<body class="store-admin"><main class="store-admin-login"><section class="card store-admin-panel">
    <p class="eyebrow">Área privada</p><h1>Administración de fotos</h1>
