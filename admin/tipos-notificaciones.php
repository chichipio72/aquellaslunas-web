        ...
        <form method="post" class="notification-types-admin__form">
            ...
            <section class="notification-types-admin__section" aria-labelledby="notification-schedule-heading">
                ...
                <div class="notification-types-admin__fields notification-types-admin__fields--schedule">
                    <label class="notification-types-admin__field">Modo<select name="default_schedule_mode"><option value="before_event"<?= ($selected['default_schedule_mode'] ?? '') === 'before_event' ? ' selected' : '' ?>>Antes del evento</option><option value="fixed_local_time"<?= in_array(($selected['default_schedule_mode'] ?? ''), ['fixed_local_time', 'fixed_time'], true) ? ' selected' : '' ?>>Hora local fija</option></select></label>
                    ...
                    <label class="notification-types-admin__field">Política de No molestar<select name="default_quiet_policy"><option value="omit"<?= ($selected['default_quiet_policy'] ?? '') === 'omit' ? ' selected' : '' ?>>Omitir</option><option value="postpone"<?= ($selected['default_quiet_policy'] ?? '') === 'postpone' ? ' selected' : '' ?>>Postergar al fin del silencio</option><option value="ignore"<?= ($selected['default_quiet_policy'] ?? '') === 'ignore' ? ' selected' : '' ?>>Ignorar horario</option></select></label>
