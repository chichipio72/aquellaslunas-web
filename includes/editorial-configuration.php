...
function astronomyEditorialCatalog(): array
{
    return [
        ...
        'events' => ['context' => 'Eventos', 'label' => 'Conjunciones, fases y órbita', 'parameters' => [
            ...
            'event.node.ascending.title' => ['label' => 'Título público de nodo ascendente', 'default' => 'La Luna cruza hacia el norte'],
            'event.node.descending.title' => ['label' => 'Título público de nodo descendente', 'default' => 'La Luna cruza hacia el sur'],
            'event.node.ascending.summary' => ['label' => 'Resumen de nodo ascendente', 'default' => 'La Luna atraviesa el plano de la órbita terrestre y pasa hacia el norte.'],
            'event.node.descending.summary' => ['label' => 'Resumen de nodo descendente', 'default' => 'La Luna atraviesa el plano de la órbita terrestre y pasa hacia el sur.'],
            'event.node.ascending.label' => ['label' => 'Etiqueta corta de nodo ascendente', 'default' => 'Nodo ascendente'],
            'event.node.descending.label' => ['label' => 'Etiqueta corta de nodo descendente', 'default' => 'Nodo descendente'],
            'event.node.eclipse_explanation' => ['label' => 'Relación educativa entre nodos y eclipses', 'default' => 'Los eclipses sólo pueden ocurrir cuando una Luna nueva o llena sucede cerca de uno de estos puntos de cruce.'],
        ...
        'tonight' => ['context' => 'El cielo esta noche', 'label' => 'Momentos y visibilidad nocturna', 'parameters' => [
            ...
            'tonight.card.lunar_eclipse' => ['label' => 'Eclipse lunar protagonista', 'default' => 'Esta noche será visible {eclipse} desde tu ubicación. Máximo: {hora}.', 'allowed' => ['eclipse', 'hora'], 'required' => ['eclipse', 'hora']],
            'tonight.lunar_eclipse.section_title' => ['label' => 'Eclipse lunar: título de sección', 'default' => 'Eclipse lunar esta noche'],
            'tonight.lunar_eclipse.card_title' => ['label' => 'Eclipse lunar: título de tarjeta y simulación', 'default' => 'Eclipse visible desde tu ubicación'],
            ...
            'tonight.card.connector.and' => ['label' => 'Conector para el último dato del resumen', 'default' => 'y'],
        ]],
        ...
        'eclipses' => ['context' => 'Eclipses', 'label' => 'Visibilidad local de eclipses', 'texts' => [
            'home.eclipse.notice.today' => ['label' => 'Portada: eclipse visible hoy', 'default' => '{momento} podremos ver {eclipse}.', 'allowed' => ['momento', 'eclipse'], 'required' => ['momento', 'eclipse']],
            'home.eclipse.notice.tomorrow' => ['label' => 'Portada: eclipse visible mañana', 'default' => 'Mañana podremos ver {eclipse}.', 'allowed' => ['eclipse'], 'required' => ['eclipse']],
            'home.eclipse.notice.future' => ['label' => 'Portada: eclipse visible en próximos días', 'default' => 'En {dias} días vamos a poder ver {eclipse}.', 'allowed' => ['dias', 'eclipse'], 'required' => ['dias', 'eclipse']],
